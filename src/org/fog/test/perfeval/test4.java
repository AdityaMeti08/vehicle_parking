...
import org.fog.scheduler.HottestFirstScheduler;
...
public class test4 {
	private static class HottestFirstScheduler {
	    private List<FogDevice> devices;
	    private int currentIndex = 0;

	    public HottestFirstScheduler(List<FogDevice> devices) {
	    ...
	    public String getNextDeviceName() {
	        if (!devices.isEmpty()) {
	            FogDevice hottestDevice = devices.get(currentIndex);
	...
	abstract class ModulePlacementRoundRobin extends ModulePlacement {
	    private HottestFirstScheduler scheduler;
	    private ModuleMapping moduleMapping;

	    public ModulePlacementRoundRobin(List<FogDevice> fogDevices, HottestFirstScheduler scheduler) {
	        super();
