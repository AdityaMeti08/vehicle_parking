...
import org.fog.scheduler.HierarchicalClustering;
...
public class KMeansScheduler{
  ...
  private static class Kmeans {
    ...
    public Kmeans(List<FogDevice> devices) {
	...
	abstract class ModulePlacementkmeans extends ModulePlacement {
	    private HierarchicalClustering scheduler;
	    private ModuleMapping moduleMapping;

	    public ModulePlacementkmeans(List<FogDevice> fogDevices, HierarchicalClustering scheduler) {
	        super();
