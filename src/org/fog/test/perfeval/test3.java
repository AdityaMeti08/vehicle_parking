...
import org.fog.scheduler.ShortestTimeFirst;
...
public class test3 {
	private static class ShortestTimeFirst {
	    private List<FogDevice> devices;
	    private int currentIndex = 0;

	    public ShortestTimeFirst(List<FogDevice> devices) {
	    ...
	    public String getNextDeviceName() {
	        if (!devices.isEmpty()) {
//	            sortDevicesByProcessingTimeAscending();
	            FogDevice shortestTimeDevice = devices.get(currentIndex);
	            currentIndex = (currentIndex + 1) % devices.size(); // Move to the next device in a circular manner
	            return shortestTimeDevice.getName();
	        }
	...
	abstract class ModulePlacementRoundRobin extends ModulePlacement {
	    private ShortestTimeFirst scheduler;
	    private ModuleMapping moduleMapping;

	    public ModulePlacementRoundRobin(List<FogDevice> fogDevices, ShortestTimeFirst scheduler) {
	        super();
