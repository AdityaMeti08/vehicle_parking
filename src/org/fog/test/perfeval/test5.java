...
import org.fog.scheduler.CentralizedScheduler;
...
public class test5 {
	private static class CentralizedScheduler {
	    private List<FogDevice> devices;
	    private int currentIndex = 0;

	    public CentralizedScheduler(List<FogDevice> devices) {
	...
	abstract class ModulePlacementCentralized extends ModulePlacement {
	    private CentralizedScheduler scheduler;
	    private ModuleMapping moduleMapping;

	    public ModulePlacementCentralized(List<FogDevice> fogDevices, CentralizedScheduler scheduler) {
	        super();
