...
import org.fog.scheduler.DBSCANClustering;
...
public class teat8{
  ...
  private static class Kmeans {
	...
	abstract class ModulePlacementkmeans extends ModulePlacement {
	    private DBSCANClustering scheduler;
	    private ModuleMapping moduleMapping;

	    public ModulePlacementkmeans(List<FogDevice> fogDevices, DBSCANClustering scheduler) {
	        super();
