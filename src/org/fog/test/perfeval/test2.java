...
public class test2 {
	private static class FCFScheduler {
	    private List<FogDevice> devices;
	    private int currentIndex = 0;

	    public FCFScheduler(List<FogDevice> devices) {
	...
	abstract class ModulePlacementRoundRobin extends ModulePlacement {
	    ...
	    public ModulePlacementRoundRobin(List<FogDevice> fogDevices, FCFS scheduler) {
	        super();
